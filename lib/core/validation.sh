...
check_ssl_expiration() { milou_check_ssl_expiration "$@"; }
validate_certificate_domain() { milou_validate_certificate_domain "$@"; }
ssl_validate_cert_key_pair() { milou_ssl_validate_cert_key_pair "$@"; }
...
export -f milou_validate_ssl_certificates milou_check_ssl_expiration milou_validate_certificate_domain milou_ssl_validate_cert_key_pair milou_is_running_as_root milou_user_exists
